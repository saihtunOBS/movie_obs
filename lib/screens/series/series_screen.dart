        ...
        actions: [
          InkWell(
            ...
            child: Container(
              ...
              child: Icon(CupertinoIcons.line_horizontal_3_decrease,color: kWhiteColor,),
            ),
          ),
          kMarginMedium2.hGap
        ],
        ...
        child: Stack(
          children: [
            ...
            filteredSuggestions.isEmpty
                ? SizedBox.shrink()
                : Container(decoration: BoxDecoration(borderRadius: BorderRadius.circular(15),color: Colors.black12,),),
            filteredSuggestions.isEmpty
                ? SizedBox()
                : Container(
